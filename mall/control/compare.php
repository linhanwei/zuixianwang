...
class compareControl extends BaseHomeControl{
    ...
    public function addcompareOp(){
        ...
        setMyCookie('comparegoods', $comparegoods_str);
    ...
    public function showcompareOp(){
        ...
        if($gid_arr){
            ...
            if ($goods_listtmp){
                ...
                //更新cookie数据
                setMyCookie('comparegoods', $goodsid_arr?implode(',',$goodsid_arr):'');
            } else {
                //更新cookie数据
                setMyCookie('comparegoods','',-3600);
            }
        }
    ...
    public function delcompareOp(){
        ...
        //更新cookie数据
        if($gid_str){
            setMyCookie('comparegoods', $gid_str);
        } else {
            setMyCookie('comparegoods','',-3600);
        }
