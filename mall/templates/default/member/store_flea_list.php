...
<div class="wrap">
  ...
  <table class="ncm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        <td></td>
        <td><div class="goods-pic-small"> <span class="thumb size60"> <i></i><a href="index.php?act=flea_goods&goods_id=<?php echo $val['goods_id']; ?>" target="_blank"><img height="50" width="50" src="<?php if ($val['goods_image']) { echo $val['goods_image']; } else { echo MALL_TEMPLATES_URL.'/images/member/default_image.png'; } ?>" onload="javascript:DrawImage(this,60,60);" /></a></span></div></td>
