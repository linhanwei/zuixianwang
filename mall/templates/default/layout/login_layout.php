...
<link href="<?php echo MALL_TEMPLATES_URL;?>/css/member_login.css" rel="stylesheet" type="text/css">
...
<script src="<?php echo MALL_RESOURCE_SITE_URL?>/js/taglibs.js"></script>
<script src="<?php echo MALL_RESOURCE_SITE_URL?>/js/tabulous.js"></script>
</head>
<body>
<div class="header-wrap">
  <header class="public-head-layout wrapper">
    <h1 class="site-logo"><a href="<?php echo MALL_SITE_URL;?>"><img src="<?php echo UPLOAD_SITE_URL_HTTPS.DS.ATTACH_COMMON.DS.$output['setting_config']['site_logo']; ?>" class="pngFix"></a></h1>
