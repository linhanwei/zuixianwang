...
<link href="<?php echo MALL_TEMPLATES_URL;?>/css/store_header.css" rel="stylesheet" type="text/css">
<!--[if IE 7]>
...
<div class="header-wrap">
  <header class="public-head-layout wrapper">
    <h1 class="site-logo"><a href="<?php echo MALL_SITE_URL;?>"><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$output['setting_config']['site_logo']; ?>" class="pngFix"></a></h1>
