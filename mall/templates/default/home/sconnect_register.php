...
<div class="nc-login-layout">
  <div class="left-pic"><img src="<?php echo MALL_TEMPLATES_URL;?>/images/login_weibo.jpg" /><span><?php echo $output['sinauser_info']['name'];?> </span> </div>
      ...
      <form name="register_form" id="register_form" method="post" action="index.php?act=sconnect&op=register">
        ...
        <dl>
          ...
          <dd>
            ...
            <img src="index.php?act=seccode&op=makecode&hash=<?php echo $output['hash'];?>" title="<?php echo $lang['login_index_change_checkcode'];?>" name="codeimage" border="0" id="codeimage" onclick="this.src='index.php?act=seccode&op=makecode&hash=<?php echo $output['hash'];?>&t=' + Math.random()"  class="fl ml5"><a href="javascript:void(0)" class="fl ml5" onclick="javascript:document.getElementById('codeimage').src='index.php?act=seccode&op=makecode&hash=<?php echo $output['hash'];?>&t=' + Math.random();"><?php echo $lang['login_index_change_checkcode'];?></a>
            <input name="hash" type="hidden" value="<?php echo $output['hash'];?>" />
            <label></label>
          </dd>
        </dl>
        <?php } ?>
      ...
      <form name="log_form" id="log_form" method="post" action="index.php?act=sconnect&op=login">
        ...
        <dl>
          ...
          <dd style="min-height:54px;">
            ...
            <img src="index.php?act=seccode&op=makecode&hash=<?php echo $output['hash'];?>" title="<?php echo $lang['login_index_change_checkcode'];?>" border="0" id="codeimage2" name="codeimage2" onclick="this.src='index.php?act=seccode&op=makecode&hash=<?php echo $output['hash'];?>&t=' + Math.random()" class="fl ml5"><a href="javascript:void(0)" class="fl ml5" onclick="javascript:document.getElementById('codeimage2').src='index.php?act=seccode&op=makecode&hash=<?php echo $output['hash'];?>&t=' + Math.random();"><?php echo $lang['login_index_change_checkcode'];?></a>
            <input name="hash" type="hidden" value="<?php echo $output['hash'];?>" />
            <label></label>
          </dd>
        </dl>
    ...
    $('#register_form').validate({
        ...
        rules : {
            ...
            captcha : {
                required : true,
                remote   : {
                	url : 'index.php?act=seccode&op=check&hash=<?php echo $output['hash'];?>',
                    type: 'get',
                    data:{
                        captcha : function(){
                            return $('#captcha').val();
