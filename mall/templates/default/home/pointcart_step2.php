  ...
  <div class="ncc-main">
    <div class="ncc-title">
      ...
      <div class="ncc-receipt-info mb30">
        ...
        <div class="ncc-finish-b">可通过用户中心<a href="<?php echo MALL_SITE_URL?>/index.php?act=member_pointorder&op=orderlist">积分兑换记录</a>查看兑换单状态。

        </div>
        <div class="ncc-finish-c mb30">
        <a class="ncc-btn-mini ncc-btn-green mr15" href="<?php echo MALL_SITE_URL?>"><i class="icon-shopping-cart"></i>继续购物</a>
