    ...
    <dl>
      ...
      <dd>
        <div class="ncsc-upload-thumb store-sns-pic">
          <p><img nctype="normal_img" src="<?php echo MALL_TEMPLATES_URL?>/images/member/default_image.png"/></p>
...
$(function(){
	...
	$('#normal_file').unbind().live('change', function(){
		$('img[nctype="normal_img"]').attr('src',MALL_TEMPLATES_URL+"/images/loading.gif");
