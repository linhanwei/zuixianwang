...
<tr><td colspan="4" style="border-bottom:1px solid #ccc"><h3 style="font-size:20px;line-height:60px"><?php echo C('site_name');?> - 实物订单商家佣金结算单</h3></td></tr>
<tr>
...
<td>结算状态</td><td><?php echo billState($output['bill_info']['oc_state']);?></td></tr>
<?php if ($output['bill_info']['oc_state'] == BILL_STATE_SUCCESS){?>
<tr>
<td>
结算日期</td><td><?php echo date('Y-m-d',$output['bill_info']['ob_pay_commis_date']);?>
</td>
</tr>
<?php }?>
<tr><td>商家应收</td><td colspan="3"><?php echo $output['bill_info']['oc_commis_totals'] - $output['bill_info']['oc_commis_return_totals'];?></td></tr>
<tr><td>结算明细</td><td colspan="3"></td></tr>
<tr><td colspan="4"><?php echo $output['bill_info']['oc_commis_totals'];?> (佣金金额) - <?php echo $output['bill_info']['oc_commis_return_totals'];?> (退单佣金)</td></tr>
</table>