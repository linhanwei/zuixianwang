        ...
        <div class="panel-body">
            <form id="recharge_form" class="am-form transfer-form" action=""  method="post" target="_blank">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="pdr_amount" name="pdr_amount" placeholder="请输入充值金额" style="IME-MODE: disabled;" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" maxlength="5" size="14">
                </div>
                <div class="form-group">
                ...
                <button type="button" class="btn btn-default" id="rechargebtn">确定</button>
            </form>
        </div>
    </div>
</div>
