...
function build(){
	...
	$list = array(
        ...
        BASE_PATH.'/framework/libraries/myqrcode.php',
...
//	}
	...
	$compile .= "\nBase::run();";
	file_put_contents(RUNCOREPATH,compress_code("<?php defined('InSystem') or exit('Access Invalid!');".$compile));
}
...
function compile($filename) {
    ...
    $content = str_ireplace("defined('InSystem') or exit('Access Invalid!')", '', $content);
