...
<div class="ncsc-form-default">
  <form id="add_form" action="index.php?act=store_livegroup&op=edit_livegroupbuy" method="post" enctype="multipart/form-data">
    <dl>
      <dt><i class="required">*</i>抢购名称:</dt>
      <dd>
        <input class="w400 text" name="groupbuy_name" type="text" id="groupbuy_name" value="<?php echo $output['groupbuy']['groupbuy_name'];?>" maxlength="60"  />
        <span></span>
    ...
    <dl>
      ...
      <dd>
        <input class="w400 text" name="remark" type="text" id="remark" value="<?php echo $output['groupbuy']['groupbuy_remark'];?>" maxlength="60"  />
        <span></span>
    ...
    <dl>
      ...
      <dd>
        <input id="start_time" name="start_time" type="text" class="text w130" value="<?php echo date("Y-m-d H:i",$output['groupbuy']['start_time']);?>" />
    ...
    <dl>
      ...
      <dd>
        <input id="end_time" name="end_time" type="text" class="text w130" value="<?php echo date("Y-m-d H:i",$output['groupbuy']['end_time']);?>" />
        <em class="add-on"><i class="icon-calendar"></i></em><span></span>
        <p class="hint">抢购结束时间应大于抢购开始时间</p>
      </dd>
    </dl>
    <dl>
      <dt><i class="required">*</i>有效期<?php echo $lang['nc_colon'];?></dt>
      <dd>
        <input id="validity" name="validity" type="text" class="text w130" value="<?php echo date("Y-m-d H:i",$output['groupbuy']['validity']);?>" />
        <em class="add-on"><i class="icon-calendar"></i></em><span></span>
    ...
    <dl>
      ...
      <dd>
        <input class="w70 text" id="original_price" name="original_price" type="text" value="<?php echo $output['groupbuy']['original_price'];?>"/>
    ...
    <dl>
      ...
      <dd>
        <input class="w70 text" id="groupbuy_price" name="groupbuy_price" type="text" value="<?php echo $output['groupbuy']['groupbuy_price'];?>"/>
        <em class="add-on"><i class="icon-renminbi"></i></em> <span></span>
    ...
    <dl>
      ...
      <dd>
        <input class="w70 text" id="buyer_count" name="buyer_count" type="text" value="<?php echo $output['groupbuy']['buyer_count'];?>"/>
        <span></span>
    ...
    <dl>
      ...
      <dd>
        <input class="w70 text" id="buyer_limit" name="buyer_limit" type="text" value="<?php echo $output['groupbuy']['buyer_limit'];?>"/>
        <span></span>
    ...
    <dl>
      ...
      <dd>
        <div class="ncsc-upload-thumb groupbuy-pic">
          <p> <img nctype="img_groupbuy_image" src="<?php echo lgthumb($output['groupbuy']['groupbuy_pic'], 'max');?>"/></p>
        </div>
    ...
    <dl>
      ...
      <dd>
        <div class="ncsc-upload-thumb groupbuy-commend-pic">
          <p><i class="icon-picture"></i> <img nctype="img_groupbuy_image" src="<?php echo lgthumb($output['groupbuy']['groupbuy_pic1'], 'max');?>"/></p>
        </div>
    ...
    <dl>
      ...
      <dd>
        <select id="class" name="class" class="w80">
          ...
          <option value="<?php echo $class['live_class_id'];?>" <?php if($class['live_class_id']==$output['groupbuy']['class_id']){ echo 'selected';}?>><?php echo $class['live_class_name'];?></option>
          <?php }?>
          <?php }?>
        </select>
    ...
    <dl>
      ...
      <dd>
        <select id="city" name="city" class="w80">
          <option value="">请选择...</option>
          <?php if(!empty($output['city_list'])){?>
          <?php foreach($output['city_list'] as $city_list){?>
          <option value="<?php echo $city_list['live_area_id'];?>" <?php if($city_list['live_area_id']==$output['groupbuy']['city_id']){ echo 'selected';}?>><?php echo $city_list['live_area_name'];?></option>
          <?php }?>
          <?php }?>
        </select>
        <select id="area" name="area" class="w80">
          ...
          <option value="<?php echo $area_list['live_area_id'];?>" <?php if($area_list['live_area_id']==$output['groupbuy']['area_id']){ echo 'selected';}?> ><?php echo $area_list['live_area_name'];?></option>
          <?php }?>
          <?php }?>
        </select>
        <select id="mall" name="mall" class="w80">
          ...
          <?php foreach($output['mall_list'] as $mall_list){?>
          <option value="<?php echo $mall_list['live_area_id'];?>" <?php if($mall_list['live_area_id']==$output['groupbuy']['mall_id']){ echo 'selected';}?> ><?php echo $mall_list['live_area_name'];?></option>
          <?php }?>
          <?php }?>
        </select>
        <span></span>
    ...
    <dl>
      ...
      <dd>
        <?php showEditor('groupbuy_intro',$output['groupbuy']['groupbuy_intro'],'740px','360px','','false',false);?>
    ...
    <div class="bottom">
      <label class="submit-border">
        ...
        <input type="hidden" name="groupbuy_id" value="<?php echo $output['groupbuy']['groupbuy_id'];?>">
...
$(document).ready(function(){
	$("select[name=s_class]").load("index.php?act=store_livegroup&op=ajax&type=class&class_id="+'<?php echo $output['groupbuy']['class_id'];?>','',function(json){
		var html = '<option value="">'+'请选择...'+'</option>';
		if(json){
			var data = eval("("+json+")");
			$.each(data,function(i,val){
				if(val.live_class_id == '<?php echo $output['groupbuy']['s_class_id'];?>'){
					html+='<option value="'+val.live_class_id+'" selected >'+val.live_class_name+'</option>';
				}else{
