...
<form method="get" action="index.php" target="_self">
  <table class="search-form">
    <input type="hidden" name="act" value="store_bill_commis" />
...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td><?php echo $bill_info['oc_commis_totals'] - $bill_info['oc_commis_return_totals'];?></td>
      <td><?php echo billState($bill_info['oc_state']);?></td>
      <td><?php echo $bill_info['oc_state'] == BILL_STATE_SUCCESS ? date('Y-m-d',$bill_info['ob_pay_commis_date']) : '';?></td>
      <td><a href="index.php?act=store_bill_commis&op=show_bill&ob_no=<?php echo $bill_info['ob_no'];?>"><?php echo $lang['nc_view'];?></a></td>
    </tr>
    <?php }?>
    <?php } else { ?>
    <tr>
