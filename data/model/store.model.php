...
class storeModel extends Model {
	 ...
	 * 按商户编号查询商户的信息
     *
	 * @param array $storeid_array 商户编号
     * @return array
	 */
    ...
    /**
     * 完全删除商户 包括店主账号、商户的管理员账号、商户相册、商户扩展
     */
...
/**
     * 获取商户列表页附加信息
     *
     * @param array $store_array 商户数组
     * @return array $store_array 包含近期销量和8个推荐商品的商户数组
     */
    ...
    /**
     * 获得商户标志、信用、商品数量、商户评分等信息
     *
     * @param	array $param 商户数组
     ...
     *
     * @param array $store_array 商户数组
     * @return array $store_array 包含商品数goods_count的商户数组
     */
