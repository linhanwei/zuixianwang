...
function send_sms($mobile,$data,$templateId = 0){
    ...
    switch($templateId){
        case 80280:
            $content = "【醉仙网】尊敬的车族宝会员,手机注册验证码是：" . $data[0] . "，请完成验证。如非本人操作，请忽略本条短信。";
            break;
        case 80283:
            $content = "【醉仙网】尊敬的车族宝会员,新登录密码是：" . $data[1] . "，请修改。如非本人操作，请忽略本条短信。";
            break;
        case 80284:
            $content = "【醉仙网】尊敬的车族宝会员,新支付密码是：" . $data[1] . "，请修改。如非本人操作，请忽略本条短信。";
            break;
        case 80286:
            $content = "【醉仙网】尊敬的车族宝会员,验证码是：" . $data[0] . "，请完成验证。如非本人操作，请忽略本条短信。";
            break;
        case 80288:
            $content = "【醉仙网】尊敬的车族宝会员,注册成功,登录密码码是：" . $data[1] . "，请完成验证。如非本人操作，请忽略本条短信。";
            break;
        default:
            //直接发内容
            $content = $data;
