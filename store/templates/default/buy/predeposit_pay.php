    ...
    <div class="ncc-receipt-info">
      ...
      <ul class="ncc-payment-list">
        ...
        <li payment_code="<?php echo $val['payment_code']; ?>">
          ...
          <i></i>
          <div class="logo" for="pay_<?php echo $val['payment_id']; ?>"> <img src="<?php echo MALL_TEMPLATES_URL?>/images/payment/<?php echo $val['payment_code']; ?>_logo.gif" /> </div>
          <div class="predeposit" nc_type="predeposit" style="display:none">
            <?php if ($val['payment_code'] == 'predeposit') {?>
                ...
                <p>当前预存款余额<br/>￥<?php echo $output['available_predeposit'];?><br/>不足以支付该订单<br/><a href="<?php echo STORE_SITE_URL.'/index.php?act=predeposit';?>">马上充值</a></p>
                <?php } else {?>
