...
<style type="text/css">
.ncs-goods-picture .levelB, .ncs-goods-picture .levelC { cursor: url(<?php echo MALL_TEMPLATES_URL;?>/images/shop/zoom.cur), pointer;}
.ncs-goods-picture .levelD { cursor: url(<?php echo MALL_TEMPLATES_URL;?>/images/shop/hand.cur), move\9;}
</style>
...
<form id="buynow_form" method="post" action="<?php echo STORE_SITE_URL;?>/index.php">
...
jQuery(function($){
	//产品图片
	$.getScript('<?php echo MALL_RESOURCE_SITE_URL?>/js/ImageZoom.js', function(){
		var
		zoomController,
		zoomControllerUl,
