  ...
  <div id="pictureIndex" class="picture-index">
    ...
    <div class="album-cover">
      <div class="cover"> <span class="thumb size190"><i></i><a href="index.php?act=sns_album&op=album_pic_list&id=<?php echo $v['ac_id']?>&mid=<?php echo $output['master_id'];?>">
        <?php if($v['ac_cover'] != ''){ ?>
        <img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$output['master_id'].DS.$v['ac_cover'];?>" onerror="this.src='<?php echo MALL_TEMPLATES_URL.'/images/member/default_image.png';?>'" >
        <?php }else{?>
        <img src="<?php echo MALL_TEMPLATES_URL.'/images/member/default_image.png';?>" onload=>
        <?php }?>
        </a></span></div>
      <div class="title">
