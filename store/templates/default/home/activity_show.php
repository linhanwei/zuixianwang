...
<link href="<?php echo MALL_TEMPLATES_URL;?>/css/home_activity.css" rel="stylesheet" type="text/css">
...
<div class="nch-activity">
  <div id="banner_box">
    <div class="pic"><img src="<?php if(is_file(BASE_UPLOAD_PATH.DS.ATTACH_ACTIVITY.DS.$output['activity']['activity_banner'])){echo UPLOAD_SITE_URL."/".ATTACH_ACTIVITY."/".$output['activity']['activity_banner'];}else{echo MALL_TEMPLATES_URL."/images/sale_banner.jpg";}?>"/></div>
