					...
					<li class="sell_one">
					  ...
					  <div class="items_info">
						<div class="pic2 fn-left">
						  <span class="thumb size50">
							<a href="index.php?act=flea_goods&goods_id=<?php echo $val['goods_id'];?>">
								<img height="48" width="48" onload="javascript:DrawImage(this,48,48);" title="<?php echo $val['goods_name'];?>" src="<?php echo $val['goods_image']?UPLOAD_SITE_URL.DS.ATTACH_MALBUM.'/'.$val['member_id'].'/'.$val['goods_image']:MALL_TEMPLATES_URL.'/images/member/default_image.png';?>" />
							</a>
						  </span>
						</div>
				...
				<li>
				  <div class="pic fn-left">
					<span class="thumb size60">
					  <i></i>
					  <a href="index.php?act=flea_goods&goods_id=<?php echo $val['goods_id'];?>">
						<img height="60" width="60" onload="javascript:DrawImage(this,60,60);" title="<?php echo $val['goods_name'];?>" src="<?php echo $val['goods_image']?UPLOAD_SITE_URL.DS.ATTACH_MALBUM.'/'.$val['member_id'].'/'.$val['goods_image']:MALL_TEMPLATES_URL.'/images/member/default_image.png';?>" />
					  </a>
					</span>
				  </div>
				  <h3 class="fn-right">
