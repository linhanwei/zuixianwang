...
.container-bg { background: url('<?php echo MALL_TEMPLATES_URL;?>/images/invite/top.jpg') repeat-x #eee; padding-top: 0; }
.invite-bd { background: url('<?php echo MALL_TEMPLATES_URL;?>/images/invite/center3.jpg') no-repeat; height: 725px; }
...
<script type="text/javascript" src="<?php echo MALL_TEMPLATES_URL;?>/images/invite/ZeroClipboard.js"></script>
      ...
      <div class="invite-bd">
        <div class="invite-form">
          ...
          <div>
            ...
            <a class="button copy-btn" data-url="<?php echo MALL_TEMPLATES_URL;?>/images/invite/ZeroClipboard.swf" id="copy-button" href="javascrit:;" hidefocus="true">复制</a> </div>
        </div>
        ...
        <div class="invite-rebate"><a href="<?php echo urlShop('member_points','index');?>" target="_blank" hidefocus="true"><img src="<?php echo MALL_TEMPLATES_URL;?>/images/invite/income.png"></a></div>
