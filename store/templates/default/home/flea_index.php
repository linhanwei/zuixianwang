...
<link href="<?php echo MALL_TEMPLATES_URL;?>/css/flea.css"  rel="stylesheet" type="text/css" />
...
<div id="category">
  <div class="content">
    <ul>
      <li>
        <div class="items_pic"><img src="<?php echo MALL_TEMPLATES_URL;?>/images/flea/cat.gif" /></div>
        <div class="cat_list">
      ...
      <li>
        <div class="items_pic"><img src="<?php echo MALL_TEMPLATES_URL;?>/images/flea/cat2.gif" /></div>
        <div class="cat_list">
      ...
      <li>
        <div class="items_pic"><img src="<?php echo MALL_TEMPLATES_URL;?>/images/flea/cat3.gif" /></div>
        <div class="cat_list">
      ...
      <li>
        <div class="items_pic"><img src="<?php echo MALL_TEMPLATES_URL;?>/images/flea/cat4.gif" /></div>
        <div class="cat_list">
      ...
      <li>
        <div class="items_pic"><img src="<?php echo MALL_TEMPLATES_URL;?>/images/flea/cat5.gif" /></div>
        <div class="cat_list">
...
<div id="KinSlideshow" style="visibility:hidden;">
      ...
      <div class="hotgoods">
        ...
        <div class="hotgoods_G">
          <dl>
            <dt class="fn-left">
              <div class="pic">
                <span class="thumb size100">
                  <i></i>
                  <a title="<?php echo $output['new_flea_goods']['goods_name'];?>" target="_blank" href="index.php?act=flea_goods&goods_id=<?php echo $output['new_flea_goods']['goods_id']?>"><img height="100" width="100" onload="javascript:DrawImage(this,100,100);" src="<?php echo $output['new_flea_goods']['goods_image'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$output['new_flea_goods']['member_id'].DS.$output['new_flea_goods']['goods_image'] : MALL_TEMPLATES_URL.'/images/member/default_image.png';?>" /></a>
                </span>
              </div>
            </dt>
            ...
            <dd class="fn-left"><img src="<?php echo MALL_TEMPLATES_URL;?>/images/flea/zr.png" /></dd>
  ...
  <div class="ad"><script type="text/javascript" src="<?php echo STORE_SITE_URL;?>/index.php?act=adv&op=advshow&ap_id=1038"></script></div>
  ...
  <div id="fourth_items">
    <h2></h2>
    <ul>
      <li class="fn-left"><script type="text/javascript" src="<?php echo STORE_SITE_URL;?>/index.php?act=adv&op=advshow&ap_id=1043"></script></li>
      <li class="fn-left"><script type="text/javascript" src="<?php echo STORE_SITE_URL;?>/index.php?act=adv&op=advshow&ap_id=1044"></script></li>
      <li class="fn-left"><script type="text/javascript" src="<?php echo STORE_SITE_URL;?>/index.php?act=adv&op=advshow&ap_id=1045"></script></li>
      <li class="last fn-left"><script type="text/javascript" src="<?php echo STORE_SITE_URL;?>/index.php?act=adv&op=advshow&ap_id=1046"></script></li>
    </ul>
  </div>
  <div class="fn-clear"></div>
  <div id="five_items">
                  ...
                  <ul>
                    ...
                    <li>
                      <div class="pic">
                        <span class="thumb size120">
                          <i></i>
                          <a target="_blank" title="<?php echo $v['goods_name'];?>" href="index.php?act=flea_goods&goods_id=<?php echo $v['goods_id']?>"><img height="120" width="120" onload="javascript:DrawImage(this,120,120);" src="<?php echo $v['goods_image'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$v['member_id'].DS.$v['goods_image'] : MALL_TEMPLATES_URL.'/images/member/default_image.png';?>" /></a>                        </span>                      </div>
