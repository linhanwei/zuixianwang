...
<script>
    var ApiUrl = '<?php echo APP_SITE_URL; ?>';
</script>
<script type="text/javascript" src="<?php echo MALL_TEMPLATES_URL;?>/js/address.js" charset="utf-8"></script>
<div class="tabmenu">
...
<div class="ncsc-form-default">
  <form method="post"  action="index.php?act=store_setting&op=store_setting" enctype="multipart/form-data" id="my_store_form">
    ...
    <dl>
      <dt>店铺名称：</dt>
      <dd>
        <input type="text" value="<?php echo $output['store_info']['store_name'];?>" name="store_name" class="text w400"></dd>
    </dl>
    <dl>
      <dt>手机号码:</dt>
      <dd>
    ...
    <dl>
      <dt>省份：</dt>
      <dd>
        <input type="hidden" name="province_id" id="province_id" value="<?php echo $output['store_info']['province_id'];?>">
    ...
    <dl>
      <dt>城市：</dt>
      <dd>
        <input type="hidden" name="city_id" id="city_id" value="<?php echo $output['store_info']['city_id'];?>">
    ...
    <dl>
      <dt>区域：</dt>
      <dd>
        <input type="hidden" name="region_id" id="region_id" value="<?php echo $output['store_info']['region_id'];?>">
    ...
    <dl>
      ...
      <dd>
        <input class="text w200" name="store_address" maxlength="20" type="text"  id="store_address" value="<?php echo $output['store_info']['store_address'];?>" />
      </dd>
    </dl>
    <!-- <dl>
 ...
 -->
   ...
   <!--  <dl>
      ...
      <dl class="setup store-logo">
        ...
        <dd>
          <p>
            ...
            <?php } ?></p>
          <p>
            <input name="banner_1" type="file"  id="banner_1"/>      
          </p>
          <p class="hint"></p>
        </dd>
      </dl>
      <dl class="setup store-logo">
        ...
        <dd>
          <p>
            ...
            <?php } ?></p>
          <p>
            <input name="banner_2" type="file"  id="banner_2"/>      
          </p>
          <p class="hint"></p>
        </dd>
      </dl>
      <dl class="setup store-logo">
        ...
        <dd>
          <p>
            ...
            <?php } ?></p>
          <p>
            <input name="banner_3" type="file"  id="banner_3"/>      
          </p>
          <p class="hint"></p>
        </dd>
      </dl>
      <dl class="setup store-logo">
        ...
        <dd>
          <p>
            ...
            <?php } ?></p>
          <p>
            <input name="banner_4" type="file"  id="banner_4"/>      
          </p>
          <p class="hint"></p>
        </dd>
      </dl>
      <dl class="setup store-logo">
        ...
        <dd>
          <p>
            ...
            <?php } ?></p>
          <p>
            <input name="banner_5" type="file"  id="banner_5"/>      
          </p>
          <p class="hint"></p>
        </dd>
      </dl>
      <dl class="setup store-logo">
        <dt>商户介绍:</dt>
        <dd>
          <?php showEditor('store_content',$output['store_info']['store_content']);?></p>
          <p class="hint"></p>
        </dd>
      </dl>
...
var SITEURL = "<?php echo STORE_SITE_URL; ?>";
//裁剪图片后返回接收函数
...
$(function(){
	...
	$('#my_store_form').validate({
        ...
        // $('#my_store_form').onsubmit();return false;
