...
<div class="ncsc-flow-item">
  ...
  <div class="item-order">
    ...
    <dl class="line">
      ...
      <dd><a href="<?php echo STORE_SITE_URL;?>/index.php?act=store_order&op=show_order&order_id=<?php echo $output['order']['order_id'];?>" target="_blank"> <?php echo $output['order']['order_sn'];?> </a><a href="javascript:void(0);" class="a">更多<i class="icon-angle-down"></i>
