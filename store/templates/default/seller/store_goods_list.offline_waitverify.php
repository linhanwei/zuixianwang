    ...
    <tr>
      ...
      <td class="w90">
        <select name="verify">
          ...
          <option <?php if (isset($_GET['verify']) && $_GET['verify'] == $key) {?>selected<?php }?> value='<?php  echo $key;?>'><?php echo $val;?></option>
          <?php }?>
        </select>
      </td>
      <th>
...
<script type="text/javascript" src="<?php echo MALL_RESOURCE_SITE_URL;?>/js/store_goods_list.js" charset="utf-8"></script>