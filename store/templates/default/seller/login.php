...
$(document).ready(function() {
    ...
    function change_seccode() {
        $('#codeimage').attr('src', 'index.php?act=seccode&op=makecode&hash=<?php echo $output['hash'];?>&t=' + Math.random());
        $('#captcha').select();
    }
...
<div class="ncsc-login-container">
  ...
  <form id="form_login" action="index.php?act=seller_login&op=login&inajax=1" method="post" >
    ...
    <div class="input">
      ...
      <div class="code">
        <div class="arrow"></div>
        <div class="code-img"><a href="javascript:void(0)" nctype="btn_change_seccode"><img src="index.php?act=seccode&op=makecode&hash=<?php echo $output['hash'];?>" name="codeimage" border="0" id="codeimage"></a></div>
