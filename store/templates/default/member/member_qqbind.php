...
<div class="wrap">
  ...
  <div class="ncm-bind">
    ...
    <div class="revise ncm-default-form ">
      <form method="post" id="editpw_form" name="editpw_form" action="index.php?act=member_connect&op=qqunbind">
    ...
    <div class="relieve pt50">
      <p class="ico"><a href="<?php echo STORE_SITE_URL;?>/api.php?act=toqq"><img src="<?php echo MALL_TEMPLATES_URL;?>/images/qq_bind_small.gif"></a>
