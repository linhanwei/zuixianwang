...
<div class="wrap">
  ...
  <ul class="bind-account-list">
    ...
    <li>
      <div class="account-item"><span class="website-icon"><img src="<?php echo MALL_TEMPLATES_URL;?>/images/member/shareicon/shareicon_<?php echo $k;?>.png"></span>
        <dl>
