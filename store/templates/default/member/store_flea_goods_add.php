...
.box_arr .table_btn a.disable_spec {background: url(<?php echo MALL_TEMPLATES_URL;?>/images/member/btn.gif) repeat 0 -1018px;float: right;}
...
.flea_pic_list .content .standard .small_pic .cut_in {background: url(<?php echo MALL_TEMPLATES_URL;?>/images/member/picedit.png) 0px -64px;width: 16px;height: 16px;float: left;margin-left: 7px;display: inline;}.flea_pic_list .content .standard .small_pic .delete {background: url(<?php echo MALL_TEMPLATES_URL;?>/images/member/picedit.png) 0 0;display: inline;width: 16px;height: 16px;float: right;margin-right: 7px;}.flea_pic_list .content .standard .small_pic .upload-btn {width: 74px;height: 32px;padding: 0px;position: absolute;*z-index: -1;z-index: 1;left: 1px;bottom: 0px;}.flea_pic_list .content .standard .small_pic .titles {width: 66px;height: 16px;line-height: 15px;text-align: center;color: #3d3f3e;background: #fdf04c;border: 1px solid #ffba2f;position: absolute;top: 1px;left: 1px;z-index: 9999;}.flea_pic_list .content .standard .small_pic .line {width: 66px;height: 2px;overflow: hidden;background: #d8deda;position: absolute;bottom: -3px;left: -1px;}.flea_pic_list .content .standard .small_pic .help {line-height: 18px;background-color: #FFFAE3;width: 420px;height: 57px;clear: both;padding: 4px;border: 1px solid #F1E38B;}.flea_pic_list .standard .small_pic .help p {padding-left: 24px;width: 398px;}.flea_pic_list .content .standard .help .ico {background: url(<?php echo MALL_TEMPLATES_URL;?>/images/member/ico.gif) no-repeat 3px -2867px;color: #F60;}.flea_goods-attribute {width: 792px;margin-top: 0;border: none;}.flea_goods-attribute dl dd p {float: none;}.goods-gallery {width: 650px;}.goods-gallery .list li{display: inline;float: left;margin: 5px; width:90px; height:90px;position: relative;z-index: 99;cursor: pointer; border:1px solid #ddd;}</style>
              ...
              <div class="standard">
                <div id="goodsCoverPicture" class="big_pic">
                  <div class="picture"> <span class="thumb size182"><i></i>
                    ...
                    <?php } else { ?>
                    <img id="big_goods_image" src="<?php echo MALL_TEMPLATES_URL.'/images/member/default_image.png';?>" onload="javascript:DrawImage(this,182,182);" alt="" />
                    <?php } ?>
                    </span> </div>
                </div>
                <div class="small_pic" >
                  <ul id="goods_images">
                    ...
                    <li nc_type="handle_pic" file_id="<?php echo $output['goods_image'][$i]['upload_id']; ?>" thumbnail="<?php echo $output['goods_image'][$i]['file_thumb']; ?>" id="thumbnail_<?php echo $i;?>">
                      ...
                      <img id="img_<?php echo $i;?>" src="<?php echo $output['goods_image'][$i]['file_thumb'] !=''?$output['goods_image'][$i]['file_thumb']:MALL_TEMPLATES_URL.'/images/member/default_image.png';?>" onerror="this.src='<?php echo MALL_TEMPLATES_URL.'/images/member/default_image.png';?>'" onload="javascript:DrawImage(this,60,60);"/>
...
<script type="text/javascript">
var SITE_URL = "<?php echo STORE_SITE_URL; ?>";
$(function(){
...
function add_uploadedfile(file_data)
{
    ...
    if(file_data.instance == 'goods_image'){
        ...
        if($('#big_goods_image').attr('src') == '<?php echo MALL_TEMPLATES_URL.'/images/member/default_image.png';?>'){
    ...
    if (confirm('<?php echo $lang['store_goods_index_goods_del_confirm']; ?>')){
            ...
            $.getJSON(url, {'id':goods_file_id}, function(data){
                if (data.done)
                {
                	...
                	$('#img_'+id).attr('src','<?php echo MALL_TEMPLATES_URL.'/images/member/default_image.png';?>');
                	$('#'+id).html('');
                }
                else
                {
            ...
            if($('#big_goods_image').attr('src') == $('#img_'+id).attr('src')){
				$('#big_goods_image').attr('src','<?php echo MALL_TEMPLATES_URL.'/images/member/default_image.png';?>');
            }
        }
}
