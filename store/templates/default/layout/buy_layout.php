...
<link href="<?php echo MALL_TEMPLATES_URL;?>/css/home_cart.css" rel="stylesheet" type="text/css">
...
<![endif]-->
<script>
var COOKIE_PRE = '<?php echo COOKIE_PRE;?>';var _CHARSET = '<?php echo strtolower(CHARSET);?>';var SITEURL = '<?php echo STORE_SITE_URL;?>';var RESOURCE_SITE_URL = '<?php echo RESOURCE_SITE_URL;?>';var RESOURCE_SITE_URL = '<?php echo RESOURCE_SITE_URL;?>';var MALL_TEMPLATES_URL = '<?php echo MALL_TEMPLATES_URL;?>';var PRICE_FORMAT = '<?php echo $lang['currency'];?>%s';
</script>
...
<?php 
if(empty($_SESSION['dai_li'])){	
	require_once template('layout/layout_top');?>  <header class="ncc-head-layout">
    <div class="site-logo"><a href="<?php echo STORE_SITE_URL;?>"><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$output['setting_config']['site_logo']; ?>" class="pngFix"></a></div>

	
<?php
}
	if ($_GET['op'] != 'pd_pay' && $_GET['act'] != 'buy_virtual') { ?>
    <ul class="ncc-flow">
