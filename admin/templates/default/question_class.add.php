...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>问题分类添加</h3>
      <ul class="tab-base">
        <li><a href="index.php?act=question_class&op=article_class"><span><?php echo $lang['nc_manage'];?></span></a></li>
	...
	$('#article_class_form').validate({
        ...
        rules : {
            ac_name : {
                required : true,
                remote   : {
                url :'index.php?act=question_class&op=ajax&branch=check_class_name',
                type:'get',
                data:{
                    ac_name : function(){
                        return $('#ac_name').val();
