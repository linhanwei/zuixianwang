  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="javascript:;" class="current"><span>查看区域</span></a></li>
      </ul>
    </div>
  </div>
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class='align-center'>
            <a href="index.php?act=vr_groupbuy&op=area_street&parent_area_id=<?php echo $val['area_id'];?>">查看商区</a>
            |
            <a href="index.php?act=vr_groupbuy&op=area_edit&area_id=<?php echo $val['area_id'];?>"><?php echo $lang['nc_edit'];?></a>
            |
            <a href="javascript:submit_delete(<?php echo $val['area_id'];?>)"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
