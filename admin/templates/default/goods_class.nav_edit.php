...
<div class="pageshop">
  <div class="fixed-barshop"> 
    <div class="item-titleshop"><a class="back" href="index.php?act=goods_class" title="返回商品分类列表"><i class="fa fa-arrow-circle-o-left"></i></a>
...
<script type="text/javascript" src="resource/js/jquery.nyroModal.js"></script> 
<script>
$(function(){
//自动加载滚动条
