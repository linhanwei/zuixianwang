  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=points_inviter&op=points_inviter_log"><span><?php echo $lang['admin_points_log_title']?></span></a></li>
      </ul>
    </div>
  </div>
      ...
      <tbody>
        ...
        <tr class="noborder">
          ...
          <td class="vatop tips"><?php echo $lang['member_index_email']?></td>
            ...
            <td colspan="2" class="required"><label class="validation">对应单号:</label></td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform"><input type="text" id="pl_sn" name="pl_sn" class="txt"></td>
            <td class="vatop tips">填写对就单号</td>
        </tr>
        <tr>
          <td colspan="2" class="required"><label class="validation"><?php echo $lang['admin_points_pointsdesc']; ?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><textarea name="pointsdesc" id="pointsdesc" rows="6" class="tarea"></textarea></td>
          <td class="vatop tips" style="color: #FF0000;"><?php echo $lang['admin_points_pointsdesc_notice'];?></td>
        </tr>
      </tbody>
      <tfoot>
        <tr class="tfoot">
...
function checkmember(){
	...
	$.getJSON("index.php?act=points_inviter&op=checkmember", {'name':membername}, function(data){
	        if (data)
	        {
		        $("#tr_memberinfo").show();
