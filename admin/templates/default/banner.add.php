  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="" class="current"><span>新增</span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form id="doc_form" method="post" enctype="multipart/form-data">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" size="100" value="" name="b_title" id="b_title" class="infoTableInput"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" size="100" value="" name="url" id="url" class="infoTableInput"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><?php showEditor('content','');?></td>
          <td class="vatop tips"></td>
        </tr>
