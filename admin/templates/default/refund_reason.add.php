  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo '新增原因';?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form id="post_form" method="post" name="form1">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input id="reason_info" name="reason_info" value="" class="txt" type="text"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="100" name="sort" id="sort" class="txt"></td>
