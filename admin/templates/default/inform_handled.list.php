  ...
  <table class="table tb-type2" id="prompt">
    <tbody>
      ...
      <tr>
        <td>
        <ul>
            <li><?php echo $lang['inform_help3'];?></li>
          </ul></td>
      </tr>
    </tbody>
  </table>
    ...
    <table class="table tb-type2">
      <thead>
        <tr class="thead">
          ...
          <th><?php echo $lang['inform_handle_type'];?></th>
      ...
      <tbody>
        ...
        <tr class="line hover">
          ...
          <td><?php
                          if($v['inform_handle_type']==='1') echo $lang['inform_handle_type_unuse'];
                          if($v['inform_handle_type']==='2') echo $lang['inform_handle_type_venom'];
                          if($v['inform_handle_type']==='3') echo $lang['inform_handle_type_valid'];
                      ?></td>
