...
<div class="page">
  <table class="table tb-type2 order">
    ...
    <?php } ?>
      ...
      <tr>
        <td><table class="table tb-type2 goods ">
            <tbody>
              ...
              <tr>
                <td class="w60 picture"><div class="size-56x56"><span class="thumb size-56x56"><i></i><a href="<?php echo MALL_SITE_URL;?>/index.php?act=goods&goods_id=<?php echo $goods['goods_id'];?>" target="_blank"><img alt="<?php echo $lang['product_pic'];?>" src="<?php echo thumb($goods, 60);?>" /> </a></span></div></td>
                <td class="w50pre"><p><a href="<?php echo MALL_SITE_URL;?>/index.php?act=goods&goods_id=<?php echo $goods['goods_id'];?>" target="_blank"><?php echo $goods['goods_name'];?></a></p><p><?php echo orderGoodsType($goods['goods_type']);?></p></td>
      ...
      <!-- S 佣金信息 -->
      <?php if($output['order_info']['commis_amount'] > 0){ ?>
      <tr>
      	<th>佣金信息</th>
      </tr>
      <?php foreach($output['member_commis_list'] as $commis){
      if($output['is_agent']){
          if($output['member_info']['dai_type'] > $commis['dai_type']){
          	continue;
          }
          }?>
      <tr>
          <td>
          		<?php 
          			...
          			if($output['member_info']['dai_type'] == $commis['dai_type']){
          				...
          				$dai_name = $dai_name . $commis['member_name'] . ' ';
          			}
          		echo $dai_name . '获得佣金：<span class="red_common">' . $lang['currency'] . $commis['commis_amount'] . '</span>'?>
          </td>
      </tr>
