    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr style="display: none;">
          <td colspan="2" class="required"><label for="member_email"><?php echo $lang['member_index_email']?>:</label></td>
        </tr>
        ...
        <tr>
            <td colspan="2"><label class="validation" for="invite_code">推荐人:</label></td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform"><input type="text" value="<?php echo $output['member_array']['inviter_member']['member_name'];?>" id="invite_code" name="invite_code" class="txt"></td>
            <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform">
			...
			<div class="type-file-preview" style="display: none;"><img src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_COMMON; ?>/<?php echo $output['member_array']['member_avatar'];?>" id="view_img"></div>
			</span>
        ...
        <tr class="noborder" style="display: none;">
            <td class="vatop rowform onoff"><label for="is_agent1" class="cb-enable <?php if($output['member_array']['is_agent'] == '1'){ ?>selected<?php } ?>" ><span>是</span></label>
                ...
                <input id="is_agent1" name="is_agent" <?php if($output['member_array']['is_agent'] == '1'){ ?>checked="checked"<?php } ?> value="1" type="radio"></td>
            <td class="vatop tips"></td>
        </tr>
        <tr style="display: none;">
        ...
        <span id="region_agent" class="w400">
            ...
            <input type="hidden" value="<?php echo $output['member_array']['agent_cityid'];?>" name="agent_city_id" id="agent_city_id">
            <input type="hidden" value="<?php echo $output['member_array']['agent_areaid'];?>" name="agent_area_id" id="agent_area_id" class="area_agent_ids" />
            <input type="hidden" value="<?php echo $output['member_array']['agent_areainfo'];?>" name="agent_area_info" id="agent_area_info" class="area_agnet_names" />
            <?php if(!empty($output['member_array']['agent_areainfo'])){?>
                <span><?php echo $output['member_array']['agent_areainfo'];?></span>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><strong class="red"><?php echo $output['member_array']['member_points']; ?></strong>&nbsp;<?php echo $lang['points_unit']; ?></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
            <td colspan="2" class="required"><label>昨日返还金额:</label></td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform"><strong class="red"><?php echo ncPriceFormat($output['member_array']['yestoday_redeemable']); ?></strong>&nbsp;<?php echo $lang['currency_zh']; ?></td>
            <td class="vatop tips"></td>
        </tr>
        <tr>
            <td colspan="2" class="required"><label>总共返还金额:</label></td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform"><strong class="red"><?php echo ncPriceFormat($output['member_array']['available_redeemable']); ?></strong>&nbsp;<?php echo $lang['currency_zh']; ?></td>
            <td class="vatop tips"></td>
        </tr>

        <tr>
            <td colspan="2" class="required"><label>奖励:</label></td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform"><strong class="red"><?php echo $output['member_array']['member_points_inviter']; ?></strong>&nbsp;<?php echo $lang['points_unit']; ?></td>
            <td class="vatop tips"></td>
        </tr>
        <tr>
            <td colspan="2" class="required"><label>已提奖励:</label></td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform"><strong class="red"><?php echo $output['member_array']['member_points_inviter_2']; ?></strong>&nbsp;<?php echo $lang['points_unit']; ?></td>
            <td class="vatop tips"></td>
        </tr>
        <!--<tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><?php echo $lang['member_index_available'];?>&nbsp;<strong class="red"><?php echo ncPriceFormat($output['member_array']['available_predeposit']); ?></strong>&nbsp;<?php echo $lang['currency_zh']; ?></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><?php echo $lang['member_index_frozen'];?>&nbsp;<strong class="red"><?php echo ncPriceFormat($output['member_array']['freeze_predeposit']); ?></strong>&nbsp;<?php echo $lang['currency_zh']; ?></td>
          <td class="vatop tips"></td>
        </tr>
      </tbody>
      <tfoot>
