  ...
  <form method="post" name="form_typeadd" id="form_typeadd">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input class="txt" type="text" name="ct_name" value="<?php echo $output['ct_info']['ct_name'];?>" /></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input class="txt" type="text" name="ct_sort" value="<?php echo $output['ct_info']['ct_sort'];?>" /></td>
        ...
        <tr class="noborder">
          <td colspan="2" class="vatop rowform"><?php showEditor('ct_introduce', $output['ct_info']['ct_introduce']);?></td>
        </tr>
      </tbody>
      <tfoot>
        <tr class="tfoot">
