...
<div class="page">
  ...
  <form method="post" id="mg_form" name="mg_form" enctype="multipart/form-data">
    ...
    <table class="table tb-type2">
        ...
        <tbody id="mg_tbody">
            <tr id="row_0">
                <td class="w108 align-center">一般用户</td>
                <td class="align-left"><input type="text" name="mg[0][price]" value="<?php echo $output['list_setting']['member_grade'][0]['price'];?>" class="w60"/></td>
            </tr>
            <tr id="row_1">
        		<td class="w108 align-center">VIP用户</td>
        		<td class="align-left"><input type="text" name="mg[1][price]" value="<?php echo $output['list_setting']['member_grade'][1]['price'];?>" class="w60"/></td>
        	</tr>
        </tbody>
        <tfoot>
        	<tr>
