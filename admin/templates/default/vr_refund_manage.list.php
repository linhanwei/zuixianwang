...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>虚拟订单退款</h3>
      <ul class="tab-base">
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo '待审核';?></span></a></li>
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td class="align-center"><a href="index.php?act=vr_refund&op=edit&refund_id=<?php echo $val['refund_id']; ?>"> 审核 </a></td>
      </tr>
      <?php } ?>
    </tbody>
    <?php } else { ?>
