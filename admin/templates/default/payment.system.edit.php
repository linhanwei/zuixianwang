...
<div class="page">
  ...
  <form id="post_form" method="post" name="form1">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        <tr class="noborder">
          <td colspan="2" class="required"><?php echo $lang['payment_index_name'];?>: </td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><?php echo $output['payment']['payment_name'];?></td>
          <td class="vatop tips"></td>
        </tr>
        <?php if($output['payment']['payment_code'] == 'offline') { ?>
        <tr>
          <td colspan="2" class="required"><label for="parent_id"><?php echo $lang['payment_info'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><textarea name="payment_info" rows="6" class="tarea" id="payment_info" ><?php echo $output['payment']['payment_info']; ?></textarea></td>
          <td class="vatop tips"><?php echo $lang['payment_notice'];?></td>
        </tr>
        <?php } elseif ($output['payment']['payment_code'] == 'chinabank') { ?>
        <tr>
