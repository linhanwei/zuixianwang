...
<h3>选择商品添加</h3>
  ...
  <a id="btn_mb_special_goods_search2015" class="btn-search" href="javascript:;" style="vertical-align: top; margin-left: 5px;" title="搜索"></a>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#btn_mb_special_goods_search2015').on('click', function() {
