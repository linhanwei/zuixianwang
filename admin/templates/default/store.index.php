...
<div class="page">
    ...
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['manage'];?></span></a></li>
          <li><a href="index.php?act=store&op=store_joinin" ><span><?php echo $lang['pending'];?></span></a><!--
        ...
        <li><a href="index.php?act=store&op=store_bind_class_applay_list" ><span>经营类目申请</span></a></li>-->
          <!--<li><a href="index.php?act=store&op=newshop_add" ><span>新增商户</span></a></li>
          <li><a href="index.php?act=store&op=store_import" ><span>CSV导入商户</span></a></li>-->
      </ul>
    </div>
  </div>
  ...
  <tbody>
    <tr><th><label for="owner_and_name"><?php echo $lang['store_user'];?></label></th>
      <td><input type="text" value="<?php echo $output['owner_and_name'];?>" name="owner_and_name" id="owner_and_name" class="txt"></td><td></td><th><label>商户类型</label></th>
        <td>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <td class="align-center w200">
            ...
            <?php if (getStoreStateClassName($v) != 'open' && cookie('remindRenewal'.$v['store_id']) == null) {?><?php }?>
            </td>
        </tr>
        <?php } ?>
        <?php }else { ?>
