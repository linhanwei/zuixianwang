  ...
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
      <tr style="display: none;">
        ...
        <th style="display: none;">营业执照所在地：</th>
        <td style="display: none;"><?php echo $output['joinin_detail']['business_licence_address'];?></td></tr><tr>
      
        <th style="display: none;">营业执照有效期：</th>
        <td style="display: none;"><?php echo $output['joinin_detail']['business_licence_start'];?> - <?php echo $output['joinin_detail']['business_licence_end'];?></td>
      </tr>
      <tr style="display: none;">
        <th style="display: none;">法定经营范围：</th>
        <td colspan="20" style="display: none;"><?php echo $output['joinin_detail']['business_sphere'];?></td>
      </tr>
      <tr>
          <th class="w150">法人姓名：</th>
          <td colspan="20"><?php echo $output['joinin_detail']['legal_name'];?></td>
      </tr>
      <tr>
          <th class="w150">法人身份证：</th>
          <td colspan="20"><?php echo $output['joinin_detail']['idcard_no'];?></td>
      </tr>
      <tr>
          <th class="w150">法人身份证(前)：</th>
          <td colspan="20"><a nctype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['idcard_front']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['idcard_front']);?>" alt="" /> </a></td>
      </tr>
      <tr>
          <th class="w150">法人身份证(后)：</th>
          <td colspan="20"><a nctype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['idcard_back']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['idcard_back']);?>" alt="" /> </a></td>
      </tr>
      <tr>
        <th>营业执照：</th>
  ...
  <form id="form_store_verify" action="index.php?act=store&op=store_joinin_verify" method="post">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
      ...
      <tbody>
        ...
        <tr style="display: none;">
          <th class="w150" style="display: none;">店铺名称：</th>
          <td><?php echo $output['joinin_detail']['store_name'];?></td>
        </tr>
        <tr style="display: none;">
          <th>店铺等级：</th>
          <td><?php echo $output['joinin_detail']['sg_name'];?>（开店费用：<?php echo $output['joinin_detail']['sg_price'];?> 元）</td>
        </tr>
        <tr style="display: none;">
   ...
   <?php if(in_array(intval($output['joinin_detail']['joinin_state']), array(10))) { ?>
    <tr>
        <th>审核意见：</th>
