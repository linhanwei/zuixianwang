...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    <input type="hidden" name="act" value="vr_refund" />
    <input type="hidden" name="op" value="refund_all" />
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        <td><a href="index.php?act=vr_order&op=show_order&order_id=<?php echo $val['order_id'];?>"><?php echo $val['order_sn'];?></a></td>
        ...
        <td class="align-center"><?php echo $output['admin_array'][$val['admin_state']]; ?></td>
        <td class="align-center"><a href="index.php?act=vr_refund&op=view&refund_id=<?php echo $val['refund_id']; ?>"> <?php echo $lang['nc_view'];?> </a></td>
      </tr>
      <?php } ?>
    </tbody>
    <?php } else { ?>
