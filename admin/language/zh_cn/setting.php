...
$lang['point_set']		= '会员积分设置';
$lang['user_auth'] 		= '用户权限';
$lang['dis_dump']   	= '防灌水设置';
$lang['open_store_set'] = '商户设置';
$lang['credit']         = '信用评价';
$lang['domain']         = '二级域名';
...
$lang['pointssettings']   = '会员积分规则';


$lang['user_info_del']           = '会员信息清除';
$lang['click_clear']             = '点击清除';
$lang['user_info_clear']         = '会员信息清除，其拥有的商户和商品也会被清除，您确定要清除吗?';
...
$lang['default_store_logo']    = '默认商户标志';
...
$lang['image_dir_type_0']	= '按照文件名存放 (例:/商户id/图片)';
$lang['image_dir_type_1']	= '按照年份存放 (例:/商户id/年/图片)';
$lang['image_dir_type_2']	= '按照年月存放 (例:/商户id/年/月/图片)';
$lang['image_dir_type_3']	= '按照年月日存放 (例:/商户id/年/月/日/图片)';
$lang['image_width']	= '宽';
$lang['image_height']	= '高';
...
$lang['promotion_notice'] = '启用商品促销功能后，商家可以通过限时打折、满即送、优惠套装和推荐展位活动，对商户商品进行促销';
$lang['open_pointshop_isuse'] = '会员积分中心';
$lang['open_pointshop_isuse_notice'] = '会员积分中心和会员积分同时启用后，网站将增加会员积分中心频道';
$lang['open_pointprod_isuse'] = '会员积分兑换';
$lang['open_pointprod_isuse_notice'] = '会员积分兑换、会员积分功能以及会员积分中心启用后，平台发布礼品，会员的会员积分在达到要求时可以在会员积分中心中兑换礼品';
$lang['points_isuse_notice'] = '会员积分系统启用后，可设置会员的注册、登录、购买商品送一定的会员积分';
$lang['open_predeposit_isuse'] = '帐户余额';
$lang['open_predeposit_isuse_notice'] = '帐户余额启用后，会员可以给自己帐户充值进行交易，当交易支付到平台时，帐户余额不可以关闭';
$lang['voucher_allow'] = '代金券';
$lang['voucher_allow_notice'] = '代金券功能、会员积分功能、会员积分中心启用后，商家可以申请代金券活动；会员会员积分达到要求时可以在会员积分中心兑换代金券；<br>拥有代金券的会员可在代金券所属商户内购买商品时，选择使用而得到优惠';
...
$lang['site_bank_account_notice']           = '用半角逗号","分隔项目，用半角冒号":"分隔标题和内容，例："银行:中国银行,币种:人民币,账号:xxxxxxxxxxx,姓名:xxx,开户行:中国银行XX分行"';
...
$lang['if_smtp_authentication']  = '使用SMTP协议发送的邮件地址，如';
$lang['smtp_user_name']          = 'SMTP 身份验证用户名';
$lang['smtp_user_name_tip']      = '如 ';
...
$lang['setting_store_creditrule']        = '商户信用';
...
$lang['points_isuse']   		= '会员积分';
$lang['points_isuse_open']    	= '开启';
$lang['points_isuse_close']    	= '关闭';
$lang['points_ruletip']    		= '会员积分规则如下';
$lang['points_item']    	 	= '项目';
$lang['points_number']    	 	= '赠送会员积分';
$lang['points_number_reg']    	= '会员注册';
$lang['points_number_login']    = '会员每天登录';
$lang['points_number_comments']    = '订单商品评论';
$lang['points_tuijian']       = '设置推荐会员积分规则';
$lang['reg_tuijian']       = '推荐注册会员积分';
$lang['regtuijian']        = '会员注册时分给推荐人会员积分数';
$lang['points_number_order']    = '购物并付款';
$lang['points_number_orderrate']    = '消费额与赠送会员积分比例';
$lang['points_number_orderrate_tip']    = '例:设置为10，表明消费10单位货币赠送1会员积分';
$lang['points_number_ordermax']    = '每订单最多赠送会员积分';
$lang['points_number_ordermax_tip']    = '例:设置为100，表明每订单赠送会员积分最多为100会员积分';
...
$lang['share_notice'] 	= '开启站外分享功能并设置站外分享绑定的相应接口后，SNS分享商户和商品信息功能中将可以使用站外分享信息功能';


$lang['seo_set_index'] 		= '首页';
$lang['seo_set_group'] 		= '抢购';
$lang['seo_set_brand'] 		= '品牌';
$lang['seo_set_point'] 		= '会员积分中心';
$lang['seo_set_article'] 	= '文章';
$lang['seo_set_shop'] 		= '商户';
...
$lang['seo_set_tips4'] 	= '商户名称 {shopname}，（应用范围：商户页）';
$lang['seo_set_tips5'] 	= '关键词 {key}，（应用范围：商品关键词、文章关键词、商户关键词）';
$lang['seo_set_tips6'] 	= '简单描述 {description}，（应用范围：商品描述、文章摘要、商户关键词）';
...
$lang['seo_set_point_content'] 		= '会员积分中心商品内容';
