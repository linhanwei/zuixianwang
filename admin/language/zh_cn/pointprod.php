...
$lang['admin_pointprod_unavailable']	 		= '系统未开启会员积分中心，是否自动开启';
...
$lang['pointprod_help1']					= '使用会员积分兑换功能请先确保系统会员积分状态处于开启状态（运营 -> 基本设置），礼品会出现在会员积分中心，会员可凭会员积分兑换，兑换成功后，由系统平台进行发货。';
$lang['admin_pointprod_goods_points']		= '兑换会员积分';
...
$lang['admin_pointprod_add_goodspoint_null_error']	= '请添加兑换会员积分';
$lang['admin_pointprod_add_goodspoint_number_error']	= '兑换会员积分为整数且大于等于0';
