...
$lang['admin_predeposit_unavailable']	 	= '系统未开启帐户余额功能，正在跳转到帐户余额设置 。。。';
...
$lang['admin_predeposit_shortprice_error']		= '帐户余额金额不足，请查看用户帐户余额信息';
$lang['admin_predeposit_pricetype']				= '帐户余额类型';
...
$lang['admin_predeposit_check_tips'] 				= '审核后，等额的会员帐户余额将会被冻结，进入财务支付环节，确认操作吗?';
$lang['admin_predeposit_pay_tips'] 				= '提交后，提现单会被置为已经支付状态，同时系统从会员帐户余额中扣除相应的提现金额，确认操作吗?';
/**
 * 充值功能公用
 */
 ...
 * 充值信息编辑
 */
$lang['admin_predeposit_recharge_edit_logdesc']		= '会员充值支付状态修改减少帐户余额';
...
$lang['admin_predeposit_cash_remark_tip2']			= '备注信息将在帐户余额明细相关页显示，会员和管理员都可见';
...
$lang['admin_predeposit_cash_del_reducefreezelogdesc']		= '会员提现记录删除成功减少冻结帐户余额金额';
$lang['admin_predeposit_cash_del_adddesc']	= '会员提现记录删除成功增加帐户余额金额';
/**
 * 提现信息编辑
 */
$lang['admin_predeposit_cash_edit_reducefreezelogdesc']	= '会员提现记录状态修改为支付成功减少冻结帐户余额金额';
...
$lang['admin_predeposit_artificial_success']				= '修改会员帐户余额成功';
$lang['admin_predeposit_artificial_fail']					= '修改会员帐户余额失败';
...
$lang['admin_predeposit_artificial_member_tip_2']			= ', 当前可用帐户余额为';
$lang['admin_predeposit_artificial_member_tip_3']			= ',  冻结帐户余额为';
$lang['admin_predeposit_artificial_notice']					= '你可以选择修改可用金额或冻结金额';
/**
 * 出入明细 
 */
$lang['admin_predeposit_log_help1']			= '此处展示了帐户余额详细的变更日志信息';
